...
import static com.tp.dao.DAOUtilitaire.fermeturesSilencieuses;
import static com.tp.dao.DAOUtilitaire.initialisationRequetePreparee;
...
public class CommandeDaoImpl implements CommandeDAO {
    ...
    public void creer( Commande commande ) throws DAOException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee(connexion, SQL_INSERT, true, commande.getClient().getId(), new DateTime( commande.getDate() ),
                    commande.getMontant(),
    ...
    private Commande map( ResultSet resultSet ) throws SQLException {
        ...
        commande.setDate( new DateTime( resultSet.getTimestamp( "date" )).toString() );
